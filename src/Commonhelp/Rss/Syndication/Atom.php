...
namespace Commonhelp\Rss\Syndication;
...
class Atom extends Writer
{
    ...
    public function execute($filename = ''){
        ...
        $id->appendChild($this->dom->createTextNode($this->siteUrl));
        $feed->appendChild($id);
        ...
        $this->addLink($feed, $this->siteUrl);

        // <link rel="self" type="application/atom+xml" href="http://example.org/feed.atom"/>
        $this->addLink($feed, $this->feedUrl, 'self', 'application/atom+xml');
