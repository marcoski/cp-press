...
class CpWidgetPortfolioSettings extends AccordionElementField
{
    public function __construct(SettingsSectionInterface $section)
    {
        $this
            ->setId('cp-widget-portfolio-settings')
            ->setTitle(__('Portfolio Widget Settings', 'cppress'))
            ->setSection($section)
            ->setName('cp-widget-portfolio-settings');
    }
