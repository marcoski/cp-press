...
class CpWidgetSocialbuttonSettings extends AccordionElementField
{
    public function __construct(SettingsSectionInterface $section)
    {
        $this
            ->setId('cp-widget-socialbutton-settings')
            ->setTitle(__('Social Button Widget Settings', 'cppress'))
            ->setSection($section)
            ->setName('cp-widget-socialbutton-settings');
    }
