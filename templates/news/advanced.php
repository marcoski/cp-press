<div class="cp-widget-field cp-widget-type-section ">
	...
	<div class="cp-widget-section">
		...
		<div class="cp-widget-field">
			<label><?php _e('Filter by News Category', 'cppress')?>:</label>
			<select multiple="multiple" style="width:100%;" id="<?= $values['id']['categories'] ?>"
				name="<?= $values['name']['categories']; ?>[]">
				<optgroup label="<?php _e('News Categories', 'cppress'); ?>">
					<?php $categories = get_terms('news-category', array('hide_empty' => false)); ?>
		...
		<div class="cp-widget-field">
			<label><?php _e('Filter by News Tag', 'cppress')?>:</label>
			<select style="width:100%;" multiple="multiple" id="<?= $values['id']['tags'] ?>"
				name="<?= $values['name']['tags']; ?>[]">
				<optgroup label="<?php _e('News Tags', 'cppress'); ?>">
					<?php $tags = get_terms('news-tags', array('hide_empty' => false)); ?>
